...
.\venv\3.5-64\Scripts\python setup.py bdist_wheel > logs\3.5-64_build.log 2>&1
.\venv\3.6-32\Scripts\python setup.py bdist_wheel > logs\3.6-32_build.log 2>&1
.\venv\3.6-64\Scripts\python setup.py bdist_wheel > logs\3.6-64_build.log 2>&1
.\venv\3.7-32\Scripts\python setup.py bdist_wheel > logs\3.7-32_build.log 2>&1
